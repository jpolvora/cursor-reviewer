...
export declare function parseCodeReviewResponse(raw: CodeReviewResponse): ParsedCodeReviewResponse;
...
export declare function setPullRequestComments(client: AdoClient, pullRequestId: number, botTag: string, reviewsJson: string, existingKeys: Map<string, boolean>, log: (msg: string) => void): Promise<PostedReviewThread[]>;
export declare function getNewReviewsFromPlan(reviewsJson: string, existingKeys: Map<string, boolean>): CodeReviewItem[];
