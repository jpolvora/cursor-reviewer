...
export declare const GITHUB_REVIEW_THREADS_PAGE_SIZE = 100;
export declare const GITHUB_THREAD_COMMENTS_PAGE_SIZE = 50;
export declare const GITHUB_PR_COMMENTS_PAGE_SIZE = 100;
...
//# sourceMappingURL=github-queries.d.ts.map